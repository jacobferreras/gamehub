  ...
  return (
    <div className="bg-cover bg-no-repeat bg-center min-h-screen bg-black opacity-90 bg-[url('/assets/HomeBgMobile.png')] sm:bg-[url('/assets/HomeBg640.png')] lg:bg-[url('/assets/HomeBg1024.png')] 3xl:bg-[url('/assets/HomeBg.png')]">
      <div className="absolute inset-0 items-center justify-center text-center pt-55 lg:text-start lg:justify-center lg:items-center lg:px-4 lg:pt-38">
        <motion.h1
          className="font-bold  text-5xl text-white font-[Bebas Neue] pb-5 sm:pt-30 sm:text-6xl md:text-7xl md:pb-2 lg:text-7xl lg:pr-80 lg:pb-2 xl:pl-4 xl:text-7xl xl:pr-100 3xl:text-8xl 3xl:pr-300 3xl:pl-2"
        ...
        <motion.h2
          className="text-lg text-white font-semibold pb-5 px-4 sm:text-xl lg:text-lg lg:pl-2 lg:pr-158 xl:pl-6 xl:text-xl 3xl:pl-4 3xl:text-2xl"
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
      ...
      <div className="pt-136 flex flex-col justify-center items-center gap-2 sm:flex-row sm:pt-170 sm:gap-1 sm:justify-around xs:px-4 sm:px-2 md:px-4 lg:px-12 lg:gap-2 xl:px-24 3xl:pt-130 3xl:items-start 3xl:place-items-start 3xl:flex-wrap 3xl:flex-row 3xl:pl-6 3xl:pr-302  3xl:gap-y-4">
        <motion.div
