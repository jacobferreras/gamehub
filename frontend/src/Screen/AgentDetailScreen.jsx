  ...
  return (
    ...
    >
      <div className="flex flex-row justify-start pl-4">
        <Link to="/app/guide">
          <img src={BackArrow} alt="Back" className="w-8 h-8 cursor-pointer" />
        </Link>
      </div>
        ...
        <div className="flex flex-row items-stretch justify-center w-full gap-x-0">
          <div className="flex flex-col w-[55%] 3xl:w-[65%]">
            <div className="flex flex-row gap-x-2 justify-start pl-6">
              ...
              />
              <h2 className="text-xl">{agent.role}</h2>
            </div>
            <h1 className="text-8xl justify-start pl-4">{agent.name}</h1>
            <p className="flex justify-start pl-6 text-lg mt-2">
              {agent.description}
            </p>
